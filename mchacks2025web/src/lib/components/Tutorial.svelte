...
{#if !tutorial_ended}
    <div class="p-16 border-2 rounded-3xl bg-gradient-to-tr from-blue-300  to-pink-300 w-full flex align-middle items-center justify-center z-10"
         transition:fade>
        <div>
            <Keyboard color="#394955"/>
        </div>
        {#if !setup_phase}
            <div class="z-30 absolute left-0 right-0 flex flex-col py-96 mb-[-37%] space-y-6 bottom-0 items-center justify-center align-middle">
        ...
        {:else}
            <div class="z-30 absolute left-0 right-0 flex flex-col py-96 mb-[-37%] space-y-6 bottom-0 items-center justify-center align-middle">
                <div class="rounded-2xl border-4 p-4 backdrop-blur-xl backdrop-brightness-[1.3]">
    ...
    <div bind:this={handContainer} class="animate-hand absolute z-20" transition:fade>
        <div class="hand">
            <div class="!scale-150 flex flex-row gap-64">
...
<style>
    ...
    .animate-button-fast {
        animation: appearButton 4s infinite;
    }
